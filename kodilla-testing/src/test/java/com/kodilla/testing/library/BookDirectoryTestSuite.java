...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfUser() {
        ...
        when(libraryDatabaseMock.listBooksInHandsOf(myUser0Books)).thenReturn(listOf0Books);
        when(libraryDatabaseMock.listBooksInHandsOf(myUser1Books)).thenReturn(listOf1Books);
        when(libraryDatabaseMock.listBooksInHandsOf(myUser5Books)).thenReturn(listOf5Books);

        // When
        List<Book> TheUserListOf0Books = bookLibrary.listBooksInHandsOf(myUser0Books);
        List<Book> TheUserListOf1Books = bookLibrary.listBooksInHandsOf(myUser1Books);
        List<Book> TheUserListOf5Books = bookLibrary.listBooksInHandsOf(myUser5Books);
